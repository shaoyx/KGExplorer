...
public class InteractiveUserAgentHttp implements IUserAgentHttp {
    private static final Logger logger = LogManager.getLogger(InteractiveUserAgentHttp.class.getName());

    private IKGExplorationSystemHttp kgExplorationSystem;

    private ArrayList<String> currentResults;
    private CompoundAspectHttp currentState;

    private HashSet<String> posExamples = new HashSet<String>();
    private HashSet<String> negExamples = new HashSet<String>();
    private HashSet<String> totExamples = new HashSet<>();
    private ArrayList<String> newPosExamples = new ArrayList<String>();
    private ArrayList<String> newNegExamples = new ArrayList<String>();
    ...
    private void listResults() {
        ...
        if(this.currentResults != null) {
            ...
            int idx = 0;
            for(String ent : this.currentResults) {
                if(idx > 50)
                    break;
    ...
    private void addExample(String example) {
        ...
        this.posExamples.add(example);
        this.newPosExamples.add(example);
        this.totExamples.add(example);
    }

    @Override
    public void initialization(IKGExplorationSystemHttp kgExplorationSystem, String queryPath, String ratio) {
